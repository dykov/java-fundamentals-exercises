    ...
    static class CollectionUtil {
        ...
        public static <T extends BaseEntity> boolean hasDuplicates(List<T> entities, T targetEntity) {
            ...
            long count = entities.stream()
                    ...
                    .filter(targetEntity.getUuid()::equals)
                    .count();
            return count > 1;
        }
        ...
        public static <T extends BaseEntity> T findMostRecentlyCreatedEntity(Collection<T> entities) throws NoSuchElementException {
        ...
        public static void swap(List<?> elements, int i, int j) {
            ...
            parametrizedSwap(elements, i, j);
        }

        private static <T> void parametrizedSwap(List<T> elements, int i, int j) {
            T buffer = elements.get(i);
            elements.set(i, elements.get(j));
            elements.set(j, buffer);
        }
